<%@ page language="java" import="java.util.*,com.qiye.service.*,com.qiye.entity.*,com.qiye.utils.*" pageEncoding="utf-8"%>
<%
...
<div class="wrap">
	<div class="header">
		<div class="logo"><a href="index.html" target="_self"><img src="css360/logo1.png" alt=""/></a></div><!--end logo-->
		<div class="nav">
			<ul>
	...
	<div class="area">
		<div class="w331">
			...
			<div class="boxc">
			<h2>公司信息<div class="mor"><a href="Main_companyinfo" >更多&gt;&gt;</a></div></h2>
			</div>
			<div class="newb" id="newc">
                <ul>
				 	<p>本公司创建于地球起源之前，有了很久的历史！</p>
                </ul>
            </div>
		...
		<div class="w306">
			<div class="box">
				...
				<div class="boxc txt">
					...
					<div class="newb" id="newc">
                <ul>
					<p>地址:天上仙界，地上地狱，神器公司</p> <br>
					<p> 邮编: 100015 </p> <br> 
					<p> 电话: (+8610) -58781000 </p> <br> 
					<p> 其他:<a href="http://www.baidu.com" target="_blank">点击搜索 </a> </p>
                </ul>
            	</div>
				</div><!--end boxc-->
	...
	<div class="footer" style="border:none">		<p>企业门户网站</p>
	</div><!--end footer-->
</div><!--end wrap-->
