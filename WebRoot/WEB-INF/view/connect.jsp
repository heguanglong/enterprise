...
<div class="wrap">
	...
	<div class="area1" style="background:none">
		...
		<form id="form1" name="form1" method="post" action="Message_add">
						...
						<font size="4">标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题：</font><input type="text" id="title" name="title" size="100" height="40" style="width:600px;height: 30px;font-size: 15px"/><br/> <br/>
						...
						<br> 
						<input type="button" onclick="doSubmit()" id="submit" name="Submit" value="提交" />
