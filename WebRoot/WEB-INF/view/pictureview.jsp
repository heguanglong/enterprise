...
<div class="wrap">
	<div class="header">
		<div class="logo"><a href="index.html" target="_self"><img src="<%=basePath %>css360/logo1.png" /></a></div><!--end logo-->
		<div class="nav">
			<ul>
	...
	<div class="area1" style="background:none">
		<div align="center">
			<p height="160">标题：<%=picture.getTitle()%></p>
			<p height="160"><%=picture.getInfo()%></p>
