...
<div class="wrap">
	...
	<div class="area1" style="background:none">
		<div align="center">
	   <h1 style="color: blue;"><font size="5"><s:text name="注册" /></font></h1>
	  </div>
  ...
  <table width="495" height="300" border="0" align="center">
    <tr>
      <td width="139" height="20"><div align="right" class="STYLE1"><font size="4"><s:text name="姓名" />:</font></div></td>
    ...
    <tr>
      <td height="20"><div align="right" class="STYLE1"><font size="4"><s:text name="密码" />:</font></div></td>
      <td height="20"><label>
    ...
    <tr>
      <td height="20"><div align="right" class="STYLE1"><font size="4"><s:text name="确认密码" />:</font></div></td>
      <td height="20"><label>
    ...
    <tr>
      <td height="20"><div align="right" class="STYLE1"><font size="4"><s:text name="邮箱" />：</font></div></td>
      <td height="20"><label>
    ...
    <tr>
      <td height="20"><div align="right" class="STYLE1"><font size="4"><s:text name="性别" />：</font></div></td>
      <td height="20"><label>
        <input type="radio" name="sex" class="sex" value="男" />
     <font size="4"><s:text name="男" /> </font>
      <input type="radio" name="sex" class="sex" value="女" />
     <font size="4"> <s:text name="女" /></font>
      </label></td>
      <td height="20">&nbsp;</td>
    </tr>
    <tr>
      <td height="20"><label>
        ...
        <div align="center">
          <input type="button" onclick="doSubmit()" name="Submit" value="<s:text name="注册" />" />
        </div>
      </label></td>
      <td height="20"><label>
        
        <div align="center">
          <input type="reset" name="Submit2" value="<s:text name="重置" />" />
          </div>
      </label></td>
      <td height="20">&nbsp;</td>
    </tr>
